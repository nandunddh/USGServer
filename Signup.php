...
if ($checkEmail != 0) {
  ...
  $InsertQuerry = "INSERT INTO user(`name`, `email`,  `PW`, `isAdmin`, `mobilenumber`, `location`, `profile`, `device_tokens`) VALUES('$Name', '$Email', '$PW', '$isAdmin', '$mobilenumber', '$location', '$profile')";
